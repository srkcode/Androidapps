package example.srk.currencyapp.database;
...
public class CurrencyTableHelper {
    ...
    private example.srk.currencyapp.database.CurrencyDatabaseAdapter mAdapter;

    public CurrencyTableHelper(example.srk.currencyapp.database.CurrencyDatabaseAdapter adapter) {
